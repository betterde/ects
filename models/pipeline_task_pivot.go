...
type PipelineTaskPivot struct {
	...
	CreatedAt  time.Time `json:"-" validate:"-" xorm:"not null created comment('创建于') DATETIME"`
	UpdatedAt  time.Time `json:"-" validate:"-" xorm:"not null updated comment('更新于') DATETIME"`
